...
const updateFormSchema = z.object({
    firstName: z.string().min(2, "Este campo deve conter no mínimo 2 caracteres").nullish(),
    lastName: z.string().min(2, "Este campo deve conter no mínimo 2 caracteres").nullish(),
    email: z.string().email("Formato de e-mail inválido").nullish(),
    password: z.string().min(6, "Este campo deve conter no mínimo 6 caracteres").nullish(),
    confirmPassword: z.string().min(6, "Este campo deve conter no mínimo 6 caracteres").nullish()
}).partial().refine((data) => {
    if(data.password)
