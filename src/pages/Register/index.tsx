...
export const registerFormSchema = z.object({
    firstName: z.string().min(2, "Este campo deve conter no mínimo 2 caracteres"),
    lastName: z.string().min(2, "Este campo deve conter no mínimo 2 caracteres"),
    email: z.string().email("Formato de e-mail inválido"),
    password: z.string().min(6, "Este campo deve conter no mínimo 6 caracteres"),
    confirmPassword: z.string().min(6, "Este campo deve conter no mínimo 6 caracteres")
